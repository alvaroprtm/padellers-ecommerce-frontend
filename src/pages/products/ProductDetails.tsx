          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-8">
              ...
              <div className="space-y-4">
                {isOwner ? (
                  // Show Edit/Delete for product owner
                  <>
                    <button 
                  ...
                  // Show Add to Cart for other users
                  <>
                    <div className="mb-8">
                    ...
                    <button 
                      ...
                      className="w-full border-2 border-gray-600 hover:border-gray-500 hover:bg-gray-700 text-gray-200 hover:text-white font-medium py-3 px-6 rounded-lg transition-all duration-200"
                    >
                      View Cart
                    </button>
                  </>
